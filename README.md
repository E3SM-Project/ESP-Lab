...
| [`1b_lnd_leadtime_rmse_skill_map.ipynb`](jupyter/1b_lnd_leadtime_rmse_skill_map.ipynb) | Error Maps | Normalized RMSE skill maps (land: H2OSNO, H2OSOI, TWS) |
...
| [`1c_lnd_leadtime_rmse_compare.ipynb`](jupyter/1c_lnd_leadtime_rmse_compare.ipynb) | Model Comparison | Direct-RMSE comparison between E3SM land cases (absolute-value reference required; skipped for TWS) |
